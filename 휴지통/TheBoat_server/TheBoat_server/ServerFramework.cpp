...
void ServerFramework::InitServer() {
	...
	float building_size_x = 250.f;
	float building_size_z = 250.f;
	float building_size_y = 250.f;

	input_extents[0] = XMFLOAT3{ building_size_x,building_size_z,building_size_y };
	input_extents[1] = XMFLOAT3{ building_size_x,building_size_z,building_size_y };
	input_extents[2] = XMFLOAT3{ building_size_x,building_size_z,building_size_y };
	input_extents[3] = XMFLOAT3{ building_size_x,building_size_z,building_size_y };
	input_extents[4] = XMFLOAT3{ building_size_x,building_size_z,building_size_y };
	input_extents[5] = XMFLOAT3{ building_size_x,building_size_z,building_size_y };
	input_extents[6] = XMFLOAT3{ building_size_x,building_size_z,building_size_y };
	input_extents[7] = XMFLOAT3{ building_size_x,building_size_z,building_size_y };
	input_extents[8] = XMFLOAT3{ building_size_x,building_size_z,building_size_y };
	input_extents[9] = XMFLOAT3{ building_size_x,building_size_z,building_size_y };
...
void ServerFramework::SendPacket(int cl_id, void* packet) {
	...
	if (retval != 0) {
		int err_no = WSAGetLastError();
		if (err_no != WSA_IO_PENDING) {
			ErrorDisplay("SendPacket에서 에러 발생 : \n", err_no);
		}
	}
}
